    ...
    return (
        ...
        >
            ...
            >
                ...
                <p className='my-2' >
                    once upon a time i was nothing for this world today even if,
                    i am not enough for this world i can face with so many prob
                    lems so i feel better. life is a path we can build to be me
                    aningful or meaningless that is our option. don't forget by
                    anymeans we aren't suppose to be hurted any person in our path.
